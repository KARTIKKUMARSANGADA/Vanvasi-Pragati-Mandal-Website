...
const Reports = () => {
  ...
  return (
    <div className="w-full pb-24 pt-24 min-h-screen bg-white">
          ...
          {items.map((r) => (
            <li key={r.uuid || r.id} className="flex flex-wrap items-center justify-between gap-4 p-5 rounded-2xl border border-slate-100 bg-slate-50">
              ...
              <a href={r.file_url} target="_blank" rel="noopener noreferrer" download
                className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white font-bold rounded-xl hover:bg-green-700">
